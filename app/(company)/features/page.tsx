      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-8 text-xl text-slate-500 dark:text-slate-400 leading-relaxed">
            A visual outline of every functionality in the AMS platform.
            All modules are fully integrated and designed for African educational standards.
          </p>
        </motion.div>
        ...
        <div className="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, idx) => (
            <motion.div
              ...
              className="group relative rounded-3xl border border-slate-200 bg-white p-8 transition-all hover:shadow-2xl hover:border-indigo-500 dark:border-slate-800 dark:bg-slate-900"
            >
