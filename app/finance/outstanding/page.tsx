  ...
  return (
    <OutstandingBoard
      ...
      labels={{
        ...
        selectAll: t("selectAllDebtors"),
        clearSelection: t("clearSelection"),
        selectedCount: t("selectedDebtors"),
        printOfficeList: t("printOfficeList"),
        printParentNotices: t("printParentNotices"),
        noOutstanding: t("noOutstanding"),
        noOutstandingDesc: t("noOutstandingDesc"),
        noSelection: t("noDebtSelection"),
        ...
        officeListTitle: t("officeDebtListTitle"),
        issuedOn: t("budgetIssuedOn"),
        debtNoticeTitle: t("debtNoticeTitle"),
        pleaseSettle: t("pleaseSettleDebt"),
        totalBalance: t("totalBalanceDue"),
        parentSlipFooter: t("parentDebtSlipFooter"),
