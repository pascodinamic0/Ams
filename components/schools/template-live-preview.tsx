...
export function TemplateLivePreview({ template, className = "" }: TemplateLivePreviewProps) {
  ...
  return (
    <div
      className={`overflow-hidden rounded-lg border border-zinc-200 bg-zinc-100 shadow-inner dark:border-zinc-700 dark:bg-zinc-800 ${className}`}
    >
      <div className="flex items-center gap-1 border-b border-zinc-200 bg-white px-2 py-1.5 dark:border-zinc-700 dark:bg-zinc-900">
