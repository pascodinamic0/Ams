  ...
  return (
    <div className="min-h-screen bg-black pb-24 pt-[calc(env(safe-area-inset-top)+7.5rem)] sm:pt-40 md:pt-44 lg:pt-48">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <article className="mt-10 space-y-6 text-base leading-relaxed text-white/60 [&_h2]:pt-2 [&_h2]:font-display [&_h2]:text-xl [&_h2]:tracking-wide [&_h2]:text-white [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5 [&_a]:font-medium [&_a]:text-amber-500 [&_a]:underline-offset-2 hover:[&_a]:underline [&_strong]:font-semibold [&_strong]:text-white/85">
          {children}
        </article>
      </div>
    </div>
